...
class TestOrder(TestCase):
    ...
    def setUp(self):
        ...
        self.paymenttype = PaymentType.objects.create(merchantName="Visa", accountNumber="55555", expirationDate="2019-12-19", customer_id=1, createdAt="2019-12-19")
        self.product_id = OrderProduct.objects.create(product_id=2)

    def test_post_order(self):
        # define a order to be sent to the API
        new_order = {
              "createdAt": "2019-12-19 00:00:00",
        ...
        # And see if it's the one we just added by checking one of the properties. Here, customer_id.
